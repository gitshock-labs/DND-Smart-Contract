    ...
    return (
        <MenuModal title="Options">
            ...
            <div className="h5 fw-normal mt-4 mb-0 w-100">
                <a href="https://github.com/gitshock-labs" target="_blank" rel="noreferrer" className="p-2 rounded text-secondary small w-100">
                    Gitshock Edgeware is currently in open beta.
                </a>
            </div>
